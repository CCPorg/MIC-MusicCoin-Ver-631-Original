MusicCoin
MusicCoin is a decendent of Litecoin that combines the great features from Luckycoin (random blocks) and Florincoin (transaction message). Like Litecoin it uses scrypt as a proof of work scheme.
...
- The default ports are 51555 (Connect) and 51556 (RPC).
